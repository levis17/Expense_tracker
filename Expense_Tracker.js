export default class Expense_Tracker {
  constructor(querySelectorString) {
    this.root = document.querySelector(querySelectorString);
    this.root.innerHTML = Expense_Tracker.html();
      ...
      <tr>
        ...
        <td>
            <input class="input input-description" type="text"
                placeholder="Add a Decription (e.g. rent, tax, etc.)">
        </td>
        <td>
  ...
  addEntry(entry = {}) {
    this.root.querySelector(".entries").insertAdjacentHTML("beforeend", Expense_Tracker.entryHtml());
